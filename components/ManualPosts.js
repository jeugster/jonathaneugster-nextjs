    ...
    <div className="cardwrapper grid-flow-row flex-nowrap">
      <article>
        ...
        <ul>
          ...
          <li><strong>Preprocessing:</strong> The framework&aposs preprocessing capabilities allow for a minimal code base that is compatible, reliable, and accessible across devices and browsers.</li>
          ...
          <li><strong>Flexible Hosting Options:</strong> The website can be hosted inexpensively on any cloud, on bare metal or a managed service. You&aposre always in control of the software and its deployment.</li>
        </ul>
      ...
      <article>
        ...
        <p>I&aposm excited to share my personal portfolio and blog, which is built with Next.js hosted on Netlify and uses Tailwind CSS for style.</p>
        ...
        <ul>
          ...
          <li><strong>Performance audits with Lighthouse</strong>: Regular performance audits help us identify areas for improvement and optimize the site&aposs performance.</li>
